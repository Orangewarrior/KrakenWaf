...
| Field | Value |
|-------|-------|
| Title | `CMC NoSQL injection detection` |
| Severity | `High` |
...
| `rule_match` | `cmc::nosql_injection_detect:list_A=<marker-a> list_B=<marker-b>` |
| `rule_line_match` | `cmc/nosql_injection_detect.rs:generated` |
...
2. **Disable the module**: set `NOSQL_injection_detect: false` in the CMC config.
