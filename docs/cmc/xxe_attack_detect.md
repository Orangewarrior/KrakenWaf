...
| Field | Value |
|-------|-------|
| Title | `CMC XXE attack detection` |
| Severity | `High` |
...
| `rule_match` | `cmc::xxe_attack_detect:list_A=<marker-a> list_B=<marker-b> decoded_utf16=<bool>` |
| `rule_line_match` | `cmc/xxe_attack_detect.rs:generated` |
...
2. **Disable the module**: set `XXE_attack_detect: false` in the CMC config.
