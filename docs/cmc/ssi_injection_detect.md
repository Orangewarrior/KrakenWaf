...
| Field | Value |
|-------|-------|
| Title | `CMC SSI injection detection` |
| Severity | `High` |
...
| `rule_match` | `cmc::ssi_injection_detect:<matched-keyword>` |
| `rule_line_match` | `cmc/ssi_injection_detect.rs:generated` |
...
2. **Disable the module**: set `SSI_injection_detect: false` in the CMC config.
