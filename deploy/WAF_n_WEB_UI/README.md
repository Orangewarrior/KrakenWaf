...
```bash
docker build -f deploy/WAF_n_WEB_UI/Containerfile -t krakenwaf-ui-lab:2.46.0-bookworm-slim .
...
docker build -f deploy/WAF_n_WEB_UI/Containerfile -t krakenwaf-ui-lab:2.46.0-bookworm-slim .
docker save krakenwaf-ui-lab:2.46.0-bookworm-slim vulnerables/web-dvwa:latest \
